...
const JobPostingData = ({handleChange}) => {
    ...
    const SevenDaysAgonData = SevenDaysAgo.toISOString().slice(0,10);
    const ThirtyDaysAgoDate = ThirtyDaysAgo.toISOString().slice(0,10); 
    //console.log(twentyFourHoursAgoData)
  return (
    <div>
    ...
    <InputField handleChange={handleChange} value={SevenDaysAgonData} title="Last 7 days" name="test"/>
