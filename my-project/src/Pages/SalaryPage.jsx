...
const SalaryPage = () =>{
    ...
    const handleSearch = () => {
        const filter = salary.filter((job)=>job.jobTitle.toLowerCase().indexf(searchText.toLowerCase())!==-1)
        setSalary(filter)
    } 
        ...
        <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
            ...
            <div className="mt-5">
                <div className="search-box p-2 text-center mb-2">
                    ...
                    <button onClick={handleSearch}className="bg-blue text-white font-semibold px-8 py-2 rouded-sm mb-4">Search</button>
                </div>
            </div>
            <div>
                {
