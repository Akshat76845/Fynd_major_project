    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
      ...
      <div className="create-job-flex">
        ...
        <div className="lg:w-1/2 w-full">
          ...
          <input type="text" placeholder="Ex: New York" {...register("companyName")} className="create-job-input"/>
        </div>   
      </div>
      <div className="create-job-flex">
      <div className="lg:w-1/2 w-full">
      ...
      <Creatable defaultValue={selectedOption} onChange={setSelectedOption} options={options} isMulti className="create-job-inpkkut py-4 "/>
      <div>
      ...
      <textarea className="w-full pl-3 py-1.5 focus:outline-none placeholder:text-gray-700" rows={6} placeholder="Job Desciption"{...register("desciption")}/>
      </div>
      <div>
