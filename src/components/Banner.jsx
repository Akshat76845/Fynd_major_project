...
const Banner = ({query,handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 md:py-20 py-14'>
        ...
        <div className='flex md:round-s-md rounded shadow-sm ring-1 ring-inset  focus-within:ring-2 focus-within:ring-inset ring-gray-300 focus-within:ring-indigo-600 md:w-1/2 w-full'>
        ...
        <FiSearch className='absolute mt-2.5 ml-2 text-gray-400'/>
            ...
            <input type="text" name="title" id="title" placeholder='Location' className='block flex-1 border-0 bg-transparent py-1.5 pl-8 text gray-900 placeholder:text-gray-400 focus:right-0 sm:text-sm sm:leading-6' onChange={handleInputChange} value={query}/>
